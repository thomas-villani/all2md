...
DEFAULT_PPTX_DEFAULT_FONT_SIZE = 24
...
DEFAULT_PPTX_TABLE_WIDTH = 12.333
DEFAULT_PPTX_TABLE_HEIGHT_PER_ROW = 0.5
DEFAULT_PPTX_IMAGE_LEFT = 1.0
DEFAULT_PPTX_IMAGE_TOP = 2.5
DEFAULT_PPTX_IMAGE_WIDTH = 5.0
DEFAULT_PPTX_INCLUDE_NOTES = True
DEFAULT_PPTX_FORCE_TEXTBOX_BULLETS = True

# PPTX slide dimensions (widescreen 16:9)
DEFAULT_PPTX_SLIDE_WIDTH = 13.333
DEFAULT_PPTX_SLIDE_HEIGHT = 7.5

# PPTX flow layout
DEFAULT_PPTX_CONTENT_MARGIN_LEFT = 0.5
DEFAULT_PPTX_CONTENT_MARGIN_RIGHT = 0.5
DEFAULT_PPTX_CONTENT_MARGIN_TOP = 1.5  # below title area
DEFAULT_PPTX_CONTENT_MARGIN_BOTTOM = 0.5
DEFAULT_PPTX_ELEMENT_GAP = 0.2  # vertical gap between blocks
DEFAULT_PPTX_LINE_HEIGHT_FACTOR = 1.2  # line height multiplier
DEFAULT_PPTX_MIN_TEXT_HEIGHT = 0.4  # minimum text block height
DEFAULT_PPTX_IMAGE_MAX_HEIGHT = 4.5  # fallback max image height
DEFAULT_PPTX_USE_FLOW_LAYOUT = True
...
DEFAULT_HTML_FIGURES_PARSING: FiguresParsing = "figure"
