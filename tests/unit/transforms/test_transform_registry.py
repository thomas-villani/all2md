...
def sample_metadata():
    ...
    return TransformMetadata(name="test-transform", description="Test transform", transformer_class=TransformA)
...
class TestTransformRegistry:
    ...
    def test_get_transform_no_params(self, registry):
        ...
        metadata = TransformMetadata(name="simple", description="Simple transform", transformer_class=TransformA)
    ...
    def test_get_transform_with_params(self, registry):
        ...
        metadata = TransformMetadata(
            ...
            parameters={"value": ParameterSpec(type=int, default=10)},
        )
        registry.register(metadata)
    ...
    def test_get_transform_invalid_params(self, registry):
        ...
        metadata = TransformMetadata(
            ...
            description="Parameterized transform",
            transformer_class=ParameterizedTransform,
            parameters={"value": ParameterSpec(type=int, required=True)},
        )
        registry.register(metadata)
    ...
    def test_list_transforms(self, registry):
        ...
        metadata1 = TransformMetadata(name="transform-a", description="Transform A", transformer_class=TransformA)
        metadata2 = TransformMetadata(name="transform-b", description="Transform B", transformer_class=TransformB)
    ...
    def test_list_transforms_with_tags(self, registry):
        ...
        metadata1 = TransformMetadata(
            name="transform-a", description="Transform A", transformer_class=TransformA, tags=["images", "cleanup"]
        )
        metadata2 = TransformMetadata(
            name="transform-b", description="Transform B", transformer_class=TransformB, tags=["text"]
        )
        metadata3 = TransformMetadata(
            name="transform-c", description="Transform C", transformer_class=TransformC, tags=["images"]
        )
    ...
    def test_resolve_dependencies_linear(self, registry):
        ...
        metadata_a = TransformMetadata(name="a", description="Transform A", transformer_class=TransformA, priority=100)
        metadata_b = TransformMetadata(
            name="b", description="Transform B", transformer_class=TransformB, dependencies=["a"], priority=200
        )
        metadata_c = TransformMetadata(
            name="c", description="Transform C", transformer_class=TransformC, dependencies=["b"], priority=300
        )
    ...
    def test_resolve_dependencies_multiple(self, registry):
        ...
        metadata_a = TransformMetadata(name="a", description="Transform A", transformer_class=TransformA)
        metadata_b = TransformMetadata(
            name="b", description="Transform B", transformer_class=TransformB, dependencies=["a"]
        )
        metadata_c = TransformMetadata(
            name="c", description="Transform C", transformer_class=TransformC, dependencies=["a"]
        )
    ...
    def test_resolve_dependencies_circular(self, registry):
        ...
        metadata_a = TransformMetadata(
            name="a", description="Transform A", transformer_class=TransformA, dependencies=["b"]
        )
        metadata_b = TransformMetadata(
            name="b", description="Transform B", transformer_class=TransformB, dependencies=["a"]
        )
    ...
    def test_resolve_dependencies_priority(self, registry):
        ...
        metadata_a = TransformMetadata(name="a", description="Transform A", transformer_class=TransformA, priority=200)
        metadata_b = TransformMetadata(name="b", description="Transform B", transformer_class=TransformB, priority=100)
