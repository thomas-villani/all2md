...
<body>
    ...
    def test_stdout_vs_file_output(self):
        ...
        assert f"Converted {html_file} -> {output_file}" in result_file.stderr
...
class TestExitCodeConstants:
    ...
    def test_get_exit_code_for_exception_dependency_error(self):
        ...
        from all2md.cli.builder import EXIT_DEPENDENCY_ERROR, get_exit_code_for_exception
    ...
    def test_get_exit_code_for_exception_parsing_error(self):
        ...
        from all2md.cli.builder import EXIT_PARSING_ERROR, get_exit_code_for_exception
    ...
    def test_get_exit_code_for_exception_generic(self):
        ...
        from all2md.cli.builder import EXIT_ERROR, get_exit_code_for_exception
